...
<body>
    ...
    <form method="post" action="contact.php"> 
        <h3>GET IN TOUCH</h3>
        <input type="text" name="name" id="name" placeholder="Enter Your GoodName" required autocomplete="off" >
        <input type="email" name="email" id="email" placeholder="Enter your E-mail" required autocomplete="off" >
        <textarea name="message" id="message" rows="4" placeholder="Type Your Comment here...!" required></textarea>
