    ...
    <div class="container">
        <div class="outer">
            ...
            <nav>
                ...
                <div class="nav-links">
                    <ul>
                        ...
                        <li><a class="pp" id="hide3" href="./main.php">LOGOUT</a></li>
                    </ul>
            ...
            <div class="textbox">
               ...
               <span id="nonhide2">Login! and  Start your transformation today</span> </p>
            ...
            <div class="wrapper">
                ...
                <script>
                 ...
                 <script>
                        <?php if ($loggedin): ?>
                             document.getElementById("nonhide2").style.display = "none";
                        <?php else: ?>
                             document.getElementById("nonhide2").style.display = "inline-block"; 
                     <?php endif; ?>
                </script>
           <!-- *********************************************************************************      -->
